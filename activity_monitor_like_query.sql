SELECT
   WaitTime_sec  = ISNULL(w.wait_duration_ms, 0)/1000,
   ...
   r.wait_resource,
   r2.wait_resource as wait_resource2,
...
s.session_Id > 50                         -- ignore anything pertaining to the system spids.

AND 

s.session_Id NOT IN (@@SPID)     -- let's avoid our own query! :)

AND r.database_id = DB_ID()

--AND w.wait_duration_ms > 10000
...
--AND s.session_Id > 30                         -- ignore anything pertaining to the system spids.
